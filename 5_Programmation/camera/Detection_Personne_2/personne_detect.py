"""personne_detect.py | Robin Forestier | 28.03.2022
...
class PersonneDetect:
    ...
    def __init__(self):
        ...
        self.copy = []
        self.detected = []
        self.backSub = cv2.createBackgroundSubtractorKNN(history=100, dist2Threshold=500.0, detectShadows=False)
    ...
    def personne_detect(self, img):
        ...
        # Realising 4 morphology transformation to clear the image of impure pixel.
